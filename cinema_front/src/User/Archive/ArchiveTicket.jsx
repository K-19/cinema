...
let ArchiveTicket = (props) => {
    ...
    return <div>
        <ul key={props.order.id}>
            {props.order.seance.film.name + ' | Кинотеатр ' + props.order.seance.cinema.name + ' | ' + formatDate(props.order.seance) + ' | Количество билетов: ' + props.order.ticketsCount}
        </ul>
    </div>
}
